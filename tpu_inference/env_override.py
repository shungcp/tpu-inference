...
_libtpu_flags = "--xla_tpu_use_tc_device_shape_on_sc=true"
_existing = os.environ.get("LIBTPU_INIT_ARGS", "")
os.environ["LIBTPU_INIT_ARGS"] = f"{_existing} {_libtpu_flags}".strip()
