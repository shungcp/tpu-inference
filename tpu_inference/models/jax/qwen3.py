...
class Qwen3Attention(JaxModule):
    ...
    def __init__(self,
        ...
        # transformers ≥5.x removed rope_theta in favor of rope_parameters +
        # default_theta.  Fall back to default_theta or the Qwen3 default.
        self.rope_theta = getattr(config, "rope_theta",
